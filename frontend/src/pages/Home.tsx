...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Public Inventories</h2>
          <p className="text-gray-600 dark:text-gray-400 mt-2">Browse inventories shared by the community</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <Link
              to="/login"
              className="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-blue-600 bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-900/50 transition-colors"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="text-center">
            ...
            <h3 className="mt-6 text-lg font-medium text-gray-900 dark:text-white">Organize Inventory</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="mt-6 text-lg font-medium text-gray-900 dark:text-white">Team Collaboration</h3>
            <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
          ...
          <div className="text-center">
            ...
            <h3 className="mt-6 text-lg font-medium text-gray-900 dark:text-white">Analytics & Reports</h3>
            <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
